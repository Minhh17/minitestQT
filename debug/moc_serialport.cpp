...
Q_CONSTINIT static const qt_meta_stringdata_SerialPort_t qt_meta_stringdata_SerialPort = {
    {
        ...
        QT_MOC_LITERAL(11, 11),  // "dataRecevie"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 4),  // "data"
        QT_MOC_LITERAL(29, 12),  // "disconnected"
        QT_MOC_LITERAL(42, 9),  // "dataReady"
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->dataRecevie((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SerialPort::dataRecevie; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &SerialPort::disconnected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SerialPort::dataRecevie(QByteArray _t1)
{
